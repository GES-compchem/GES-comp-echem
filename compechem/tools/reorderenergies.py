...
def reorder_energies(
    ...
    for system in system_list:
        ...
        if (
            method_el.method in system.energies
            and system.energies[method_el.method].electronic is not None
        ):
            pass
        else:
        ...
        if (
            method_vib.method in system.energies
            and system.energies[method_vib.method].vibronic is not None
        ):
            pass
        else:
