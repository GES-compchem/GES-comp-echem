...
from compechem.modules.orca import r2SCAN
...
def reorder_energies(
    molecule_list, nproc=1, maxcore=350, method_opt=None, method_el=None, method_vib=None
):
    ...
    if method_el is None:
        method_el = r2SCAN(nproc=nproc, maxcore=maxcore)
    if method_vib is None:
        method_vib = XtbInput(nproc=nproc)
    ...
    for molecule in molecule_list:
        ...
        method_opt.opt(molecule, inplace=True)
